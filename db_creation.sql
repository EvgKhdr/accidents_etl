...
CREATE TABLE accidents(
    ...
    severity VARCHAR(10) CHECK (severity IN ('Unknown','Fatal', 'Slight', 'Serious')) DEFAULT 'Unknown',
...
CREATE TABLE casualties(
    ...
    class VARCHAR(10) CHECK (class IN ('Driver', 'Pedestrian', 'Passenger', 'Unknown')) DEFAULT 'Unknown',
    ...
    severity VARCHAR(10) CHECK (severity IN ('Fatal', 'Slight', 'Serious','Unknown')) DEFAULT 'Unknown',
    age_band VARCHAR (10) CHECK (age_band IN ('Child', 'Adult', 'Unknown')) DEFAULT 'Unknown'
);
